...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup(){
        ...
        security= new Choice();
        security.add("Fav Character of the boys?");
        security.add("Last School you attend?");
        security.add("Favourite person in your life?");
...
//        i1.setForeground(new Color(133,193,233));
